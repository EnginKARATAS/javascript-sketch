...
const innerTxt = document.createTextNode("Hello from this is a new text node");
paragraphEl.append(innerTxt);
const renderDiv = document.querySelector(".renderHere");
renderDiv.append(paragraphEl);
